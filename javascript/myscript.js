...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tình cảm của chúng con " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Thầy ơi';
document.querySelector('.Description .modal-body').innerHTML = 'Chúng con cảm ơn thầy vì đã luôn quan tâm chúng con ạ<3 <i class="fas fa-heart"></i> ';
